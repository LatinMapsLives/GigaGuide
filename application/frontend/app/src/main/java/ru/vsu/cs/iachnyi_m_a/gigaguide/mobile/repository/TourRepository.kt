...
interface TourRepository {
    ...
    suspend fun searchFilterTours(name: String, language: String, minDuration: Int?, maxDuration: Int?, minDistance: Double?, maxDistance: Double?): List<SightTourThumbnail>?
}