...
@HiltViewModel
class HomeScreenViewModel @Inject constructor(private val sightThumbnailRepository: SightThumbnailRepository): ViewModel() {
    ...
    fun loadClosestTours(){
        ...
        viewModelScope.launch {
            var sights: List<SightTourThumbnail> = sightThumbnailRepository.getClosestSights();
            closestTours.clear()
