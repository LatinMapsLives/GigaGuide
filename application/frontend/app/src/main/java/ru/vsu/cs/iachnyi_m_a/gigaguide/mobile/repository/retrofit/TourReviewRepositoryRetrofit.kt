...
class TourReviewRepositoryRetrofit(private val tourReviewAPI: TourReviewAPI): TourReviewRepository {
    override suspend fun getAllReviews(
        ...
        var response: Response<ReviewsDTO> =
            tourReviewAPI.getAll("Bearer $token", objectId).execute()
    ...
    override suspend fun deleteReview(token: String, id: Int): Boolean? {
        var response: Response<String> = tourReviewAPI.deleteReview("Bearer $token", id).execute()
    ...
    override suspend fun addReview(
        ...
        var response: Response<String> = tourReviewAPI.addReview(
            token = "Bearer $token",
            tourId = objectId.toInt(),
